...
namespace PumaCode.SvnDotNet.SubversionSharp {
    ...
    public sealed class Svn {
        ...
        {
            AprAllocator allocator = AllocatorCreate();
        ...
        #region SvnError
        [DllImport(SvnClientLibrary, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern
...
internal void svn_error_clear(IntPtr error);
        ...
        #region SvnPath
        [DllImport(SvnClientLibrary, CallingConvention = CallingConvention.Cdecl)]
        static extern
...
internal IntPtr svn_stream_from_aprfile(IntPtr file, IntPtr pool);
        ...
        [DllImport(SvnClientLibrary, CallingConvention = CallingConvention.Cdecl)]
        static extern
internal IntPtr svn_stream_from_aprfile2(IntPtr file, bool disown, IntPtr pool);
...
int recurse, int skip_checks, IntPtr ctx,
IntPtr pool);
...
internal IntPtr svn_lock_dup(IntPtr lck, IntPtr pool);
        ...
        [DllImport(SvnClientLibrary, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        static extern
internal IntPtr svn_wc_set_adm_dir(IntPtr name, IntPtr pool);
        #endregion
    }
}
