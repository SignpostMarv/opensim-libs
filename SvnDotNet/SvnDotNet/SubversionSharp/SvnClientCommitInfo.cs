...
namespace PumaCode.SvnDotNet.SubversionSharp {
    public unsafe class SvnClientCommitInfo : IAprUnmanaged {
        private svn_client_commit_info_t* _commitInfo;
        ...
        {
            _commitInfo = (svn_client_commit_info_t*) ptr.ToPointer();
        }
        ...
        {
            return ("[svn_client_commit_info_t:" + (new IntPtr(_commitInfo)).ToInt32().ToString("X") + "]");
        }
        #endregion
