...
namespace PumaCode.SvnDotNet.SubversionSharp {
    public partial class SvnClient {
        private readonly AprPool _globalPool;
        private AprPool _pool;
        private readonly SvnClientContext _context;
        private ArrayList _authObjects;
        ...
        public SvnClient()
        {
            _globalPool = Svn.PoolCreate();
            _pool = Svn.PoolCreate(_globalPool);
            _context = SvnClientContext.Create(_globalPool);
            _context.Config = SvnConfig.GetConfig(_globalPool);
            _authObjects = null;
        }
        ...
        public IAprUnmanaged PathOrUrl(string str)
        {
            if(SvnPath.PathIsUrl(str)) {
                return (new SvnUrl(str, _pool));
            }

            return (new SvnPath(str, _pool));
        }

        private static Type PathOrUrlArrayType(IEnumerable coll)
        {
        ...
        /// <summary>
        /// Use <paramref name="directoryName"/> for the administrative directory in the working copy.
        /// </summary>
        /// <param name="directoryName">administrative directory name</param>
        public void SetWcAdmDir(string directoryName)
        {
            SvnError err = Svn.svn_wc_set_adm_dir(new SvnPath(directoryName, _pool), _pool);
            if(!err.IsNoError)
        ...
        {
            return Checkout2(new SvnUrl(url, _pool), new SvnPath(path, _pool), peg_revision.ToSvnOpt(_pool), revision.ToSvnOpt(_pool), recurse, ignoreExternals,
                _context, _pool);
        }
        ...
        {
            AprArray arr = Update2(AprArray.LazyMake(_pool, paths, typeof(SvnPath)), revision.ToSvnOpt(_pool), recurse, ignoreExternals,
                                      _context, _pool);
        ...
        {
            return Switch(new SvnPath(path, _pool), new SvnUrl(url, _pool), revision.ToSvnOpt(_pool), recurse,
                          _context, _pool);
        }
        ...
        {
            Add3(new SvnPath(path, _pool), recurse, force, no_ignore, _context, _pool);
        }
        ...
        {
            return Mkdir2(AprArray.LazyMake(_pool, paths, PathOrUrlArrayType(paths)), _context, _pool);
        }
        ...
        {
            return Delete2(AprArray.LazyMake(_pool, paths, PathOrUrlArrayType(paths)), force, _context, _pool);
        }
        ...
        {
            return Import2(new SvnPath(path, _pool), new SvnUrl(url, _pool), nonrecursive, no_ignore, _context, _pool);
        }
        /// <summary>
        ...
        {
            return Commit3(AprArray.LazyMake(_pool, targets, typeof(SvnPath)), recurse, keep_locks,
                          _context, _pool);
        }

        /// <summary>
        /// Retrieve svnStatus of <paramref name="path"/> and its children.
        /// </summary>
        ...
        {
            return Status2(new SvnPath(path, _pool), revision.ToSvnOpt(_pool), statusFunc, statusBaton,
                          recurse, getAll, update, noIgnore, ignoreExternals, _context, _pool);
        }
        ...
        {
            Log2(AprArray.LazyMake(_pool, targets, typeof(SvnPath)),
                start.ToSvnOpt(_pool), end.ToSvnOpt(_pool), limit,
        ...
        /// <param name="receiver_baton">Blame callback function baton</param>
        ...
        {
            InternalBlame2(PathOrUrl(pathOrUrl), peg_revision.ToSvnOpt(_pool),
                          start.ToSvnOpt(_pool), end.ToSvnOpt(_pool),
                          receiver, receiver_baton, _context, _pool);
        }

        //TODO: Implement Blame3
        ...
        {
            InternalDiff3(AprArray.LazyMake(_pool, diffOptions, typeof(AprString)),
                        PathOrUrl(path1), revision1.ToSvnOpt(_pool),
                        PathOrUrl(path2), revision2.ToSvnOpt(_pool),
                        recurse, ignoreAncestry, noDiffDeleted,
                        ignoreContentType, new SvnData(header_encoding, _pool),
                        outFile, errFile, _context, _pool);
        }
        ...
        public void DiffPeg3(ICollection diffOptions,
                            ...
                            AprFile outFile, AprFile errFile)
        {
            DiffPeg3(AprArray.LazyMake(_pool, diffOptions, typeof(AprString)),
                                PathOrUrl(path), peg_revision.ToSvnOpt(_pool),
                                start_revision.ToSvnOpt(_pool), end_revision.ToSvnOpt(_pool),
                                recurse, ignoreAncestry, noDiffDeleted,
                                ignoreContentType, new SvnData(header_encoding, _pool),
                                outFile, errFile,
                                _context, _pool);
        ...
        {
            InternalMerge(PathOrUrl(source1), revision1.ToSvnOpt(_pool),
                          PathOrUrl(source2), revision2.ToSvnOpt(_pool),
                          new SvnPath(targetWCPath, _pool),
                          recurse, ignoreAncestry, force, dryRun, _context, _pool);
        }
        ...
        public void Merge(string source, SvnRevision revision1,
                          ...
                          bool ignoreAncestry, bool force, bool dryRun)
        {
            MergePeg(PathOrUrl(source), revision1.ToSvnOpt(_pool),
                  revision2.ToSvnOpt(_pool), peg_revision.ToSvnOpt(_pool),
                  new SvnPath(targetWCPath, _pool), recurse, ignoreAncestry, force, dryRun, _context, _pool);
        }
        ...
        {
            Cleanup(new SvnPath(dir, _pool), _context, _pool);
        }
        ...
        {
            Relocate(new SvnPath(dir, _pool), new SvnUrl(from, _pool), new SvnUrl(to, _pool),
                     recurse, _context, _pool);
        }
        ...
        {
            Revert(AprArray.LazyMake(_pool, paths, typeof(SvnPath)), recursive, _context, _pool);
        }
        ...
        /// If <paramref name="recurse"/> is set, recurse below <paramref name="path"/>, 
        ...
        {
            Resolved(new SvnPath(path, _pool), recurse, _context, _pool);
        }
        ...
        {
            return InternalCopy2(PathOrUrl(srcPath), srcRevision.ToSvnOpt(_pool),
                                PathOrUrl(dstPath), _context, _pool);
        }
        ...
        {
            return InternalMove3(PathOrUrl(srcPath), PathOrUrl(dstPath), force, _context, _pool);
        }
        ...
        {
            return RevPropSet(propName, propVal, new SvnUrl(url, _pool),
                              revision.ToSvnOpt(_pool), force, _context, _pool);
        }
        ...
        {
            return InternalPropGet2(propName, PathOrUrl(target), peg_revision.ToSvnOpt(_pool),
                                    revision.ToSvnOpt(_pool), recurse, _context, _pool);
        }
        ...
        {
            return RevPropGet(propName, new SvnUrl(url, _pool), revision.ToSvnOpt(_pool),
                              out setRev, _context, _pool);
        }

        public AprArray PropList(string target, SvnRevision revision, bool recurse)
        {
            return InternalPropList(new SvnPath(target, _pool), revision.ToSvnOpt(_pool), recurse,
                                    _context, _pool);
        }

        public AprHash RevPropList(string url, SvnRevision revision, out int setRev)
        {
            return RevPropList(new SvnUrl(url, _pool), revision.ToSvnOpt(_pool), out setRev,
                               _context, _pool);
        }
        ...
        {
            return InternalExport3(PathOrUrl(from), new SvnPath(to, _pool),
                                    peg_revision.ToSvnOpt(_pool), revision.ToSvnOpt(_pool),
                                    overwrite, ignore_externals, recurse, _context, _pool);
        }

        [Obsolete("Provided for backward compatibility with the 1.2 API; use List3() instead")]
        public AprHash List2(string pathOrUrl, SvnRevision peg_revision, SvnRevision revision, bool recurse)
        {
            return InternalList2(PathOrUrl(pathOrUrl), peg_revision.ToSvnOpt(_pool), revision.ToSvnOpt(_pool), recurse,
                _context, _pool);
        }

        //TODO: Replace this with call to svn_client_list; replace Obsolete method from List()
        public AprHash List3(out AprHash locks, string pathOrUrl, SvnRevision peg_revision,
                                   SvnRevision revision, bool recurse)
        {
            return InternalList3(out locks, PathOrUrl(pathOrUrl), peg_revision.ToSvnOpt(_pool), revision.ToSvnOpt(_pool), recurse, _context, _pool);
        }

        public void Cat2(SvnStream stream, string pathOrUrl, SvnRevision peg_revision, SvnRevision revision)
        {
            InternalCat2(stream, PathOrUrl(pathOrUrl), peg_revision.ToSvnOpt(_pool), revision.ToSvnOpt(_pool), _context, _pool);
        }

        public void Lock(ICollection targets, string comment, bool steal_lock)
        {
            InternalLock(AprArray.LazyMake(_pool, targets, PathOrUrlArrayType(targets)), comment, steal_lock, _context, _pool);
        }

        public void Unlock(ICollection targets, bool break_lock)
        {
            InternalUnLock(AprArray.LazyMake(_pool, targets, PathOrUrlArrayType(targets)), break_lock, _context, _pool);
        }
        ...
        {
            InternalInfo(PathOrUrl(pathOrUrl), peg_revision.ToSvnOpt(_pool), revision.ToSvnOpt(_pool), receiver, receiver_baton, recurse,
                         _context, _pool);
        }
        #endregion
        ...
        {
            return InternalUrlFromPath(PathOrUrl(pathOrUrl), _pool);
        }

        public string UuidFromUrl(string url)
        {
            return UuidFromUrl(new SvnUrl(url, _pool), _context, _pool);
        }
        #endregion
        ...
        {
            return Checkout(new SvnUrl(url, _pool), new SvnPath(path, _pool),
                            revision.ToSvnOpt(_pool), recurse, _context, _pool);
        }
        ...
        {
            return Update(new SvnPath(path, _pool), revision.ToSvnOpt(_pool), recurse,
                          _context, _pool);
        }
        ...
        {
            Add(new SvnPath(path, _pool), recurse, _context, _pool);
        }
        ...
        {
            return Mkdir(AprArray.LazyMake(_pool, paths, PathOrUrlArrayType(paths)), _context, _pool);
        }
        ...
        {
            return Delete(AprArray.LazyMake(_pool, paths, PathOrUrlArrayType(paths)), force, _context, _pool);
        }
        ...
        {
            return Import(new SvnPath(path, _pool), url, nonrecursive, _context, _pool);
        }
        ...
        {
            return Commit(AprArray.LazyMake(_pool, targets, typeof(SvnPath)), nonrecursive,
                          _context, _pool);
        }
        ...
        {
            return Status(new SvnPath(path, _pool), revision.ToSvnOpt(_pool), statusFunc, statusBaton,
                          descend, getAll, update, noIgnore, _context, _pool);
        }
        ...
        public void Log(ICollection targets,
                        ...
                        LogMessageReceiver receiver, IntPtr baton)
        {
            Log(AprArray.LazyMake(_pool, targets, typeof(SvnPath)),
                start.ToSvnOpt(_pool), end.ToSvnOpt(_pool),
                discoverChangedPaths, strictNodeHistory, receiver, baton,
                _context, _pool);
        }
        ...
        public void Diff(ICollection diffOptions,
                         ...
                         AprFile outFile, AprFile errFile)
        {
            InternalDiff(AprArray.LazyMake(_pool, diffOptions, typeof(AprString)),
                 PathOrUrl(path1), revision1.ToSvnOpt(_pool),
                 PathOrUrl(path2), revision2.ToSvnOpt(_pool),
        ...
        public void Diff(ICollection diffOptions,
            ...
            AprFile outFile, AprFile errFile)
        {
            DiffPeg(AprArray.LazyMake(_pool, diffOptions, typeof(AprString)),
                PathOrUrl(path), peg_revision.ToSvnOpt(_pool),
                start_revision.ToSvnOpt(_pool), end_revision.ToSvnOpt(_pool),
                recurse, ignoreAncestry, noDiffDeleted,
                outFile, errFile, _context, _pool);
        ...
        public void Diff(ICollection diffOptions,
            ...
            AprFile outFile, AprFile errFile)
        {
            DiffPeg2(AprArray.LazyMake(_pool, diffOptions, typeof(AprString)),
                PathOrUrl(path), peg_revision.ToSvnOpt(_pool),
                start_revision.ToSvnOpt(_pool), end_revision.ToSvnOpt(_pool),
                recurse, ignoreAncestry, noDiffDeleted, ignoreContentType,
                outFile, errFile, _context, _pool);
        ...
        {
            return InternalCopy(PathOrUrl(srcPath), srcRevision.ToSvnOpt(_pool),
                                PathOrUrl(dstPath), _context, _pool);
        }
        ...
        {
            return InternalMove(PathOrUrl(srcPath), srcRevision.ToSvnOpt(_pool),
                                PathOrUrl(dstPath), force, _context, _pool);
        }
        ...
        {
            InternalPropSet(propName, propVal, new SvnPath(target, _pool), recurse, _pool);
        }
        ...
        public AprHash PropGet(string propName, string target,
                               SvnRevision revision, bool recurse)
        {
            return InternalPropGet(propName, new SvnPath(target, _pool), revision.ToSvnOpt(_pool), recurse,
                                   _context, _pool);
        }
        ...
        {
            return InternalExport(PathOrUrl(from), new SvnPath(to, _pool), revision.ToSvnOpt(_pool),
                                  force, _context, _pool);
        }
        ...
        {
            return InternalList(PathOrUrl(pathOrUrl), revision.ToSvnOpt(_pool), recurse,
                                _context, _pool);
        }
        ...
        {
            InternalCat(stream, PathOrUrl(pathOrUrl), revision.ToSvnOpt(_pool), _context, _pool);
        }
        ...
        public void AddSimpleProvider()
        {
            if(_authObjects == null)
                _authObjects = new ArrayList();
            _authObjects.Add(SvnAuthProviderObject.GetSimpleProvider(_globalPool));
        }
        ...
        public void AddUsernameProvider()
        {
            if(_authObjects == null)
                _authObjects = new ArrayList();
            _authObjects.Add(SvnAuthProviderObject.GetUsernameProvider(_globalPool));
        }
        ...
        public void AddSslServerTrustFileProvider()
        {
            if(_authObjects == null)
                _authObjects = new ArrayList();
            _authObjects.Add(SvnAuthProviderObject.GetSslServerTrustFileProvider(_globalPool));
        }
        ...
        public void AddSslClientCertFileProvider()
        {
            if(_authObjects == null)
                _authObjects = new ArrayList();
            _authObjects.Add(SvnAuthProviderObject.GetSslClientCertFileProvider(_globalPool));
        }
        ...
        public void AddSslClientCertPwFileProvider()
        {
            if(_authObjects == null)
                _authObjects = new ArrayList();
            _authObjects.Add(SvnAuthProviderObject.GetSslClientCertPwFileProvider(_globalPool));
        }
                                      ...
                                      IntPtr promptBaton, int retryLimit)
        {
            if(_authObjects == null)
                _authObjects = new ArrayList();
            _authObjects.Add(SvnAuthProviderObject.GetPromptProvider(promptFunc, promptBaton,
                                                                  retryLimit, _globalPool));
        }
        ...
        public void OpenAuth()
        {
            if(_authObjects == null)
                _authObjects = new ArrayList();
            _context.AuthBaton = SvnAuthBaton.Open(_authObjects, _globalPool);
            _authObjects = null;
        }
        #endregion
        ...
        {
            if(PropNeedsTranslation(propName)) 
			{
				string lfString = propVal.Replace("\r\n", "\n");
                return new SvnString(new AprString(System.Text.Encoding.UTF8.GetBytes(lfString), _pool), _pool);
            }
            else 
			{
                return new SvnString(propVal, _pool);
            }
        }
        ...
        public string PropDetranslate(string propName, SvnString propVal)
        {
            if(!propVal.IsNull && propVal.Len > 0) 
			{
				if (PropNeedsTranslation(propName)) 
				{
					byte[] buffer = new byte[propVal.Data.Length];
					System.Runtime.InteropServices.Marshal.Copy(propVal.Data.ToIntPtr(), buffer, 0, propVal.Data.Length);
					return System.Text.Encoding.UTF8.GetString(buffer).Replace("\n", "\r\n");
                }
