...
namespace HttpServer.Helpers
{
    ...
    public static class FormHelper
    {
        ...
        public static string Start(string name, string action, bool isAjax, params string[] options)
        {
            if (name == null)
            ...
            if (isAjax)
            {
                ...
                WebHelper.GenerateHtmlAttributes(sb, options, new string[]{"onsubmit", onsubmit, "id", name, "method", "post"});
            }
            else
                WebHelper.GenerateHtmlAttributes(sb, options, new string[]{"id", name, "method", "post"});
